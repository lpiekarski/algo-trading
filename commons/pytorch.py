...
def train(model, x, y, loss_function, optimizer, n_epochs=100, batch_size=256, metrics=None):
    ...
    if metrics is None:
        metrics = {}
    loader = torch.utils.data.DataLoader(list(zip(x, y)), batch_size=batch_size, **cuda_kwargs)
