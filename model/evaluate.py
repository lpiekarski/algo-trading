...
@click.option("--train-label", "-trl", help="Name of the label column within the train dataset")
@click.option("--test-dataset", "-tsd", help="Labelled dataset to use for evaluation")
@click.option("--test-label", "-tsl", help="Name of the label column within the test dataset")
@click.option("--skip-save", "-ss", help="Do not save the results of the training", is_flag=True)
