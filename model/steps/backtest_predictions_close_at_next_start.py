...
@step
def backtest_predictions_close_at_next_start(dataset, y_pred, backtest_threshold, backtest_volume, backtest_tpsl_pct, backtest_commission, backtest_leverage, backtest_cash, **kwargs):
